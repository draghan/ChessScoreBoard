                     ...
                     long style): wxFrame(parent, id, title, pos, size, style)
{
    ...
    ButtonDrawPlus
            ->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnButtonDrawPlus), NULL, this);
    ButtonLossPlus
            ->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnButtonLossPlus), NULL, this);
...
MainFrame::~MainFrame()
{
    ...
    ButtonWinPlus
            ->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnButtonWinPlus), NULL, this);
    ButtonDrawPlus
            ->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnButtonDrawPlus), NULL, this);
    ButtonLossPlus
            ->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(MainFrame::OnButtonLossPlus), NULL, this);
